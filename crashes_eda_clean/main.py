...
def crashes_data_cleaning(input_path, police_beat_path, output_path):
    ...
    with tqdm(total=len(data), desc="Step 2: Updating Lat/Lng/Street Names") as step2_pbar:
        for row in data:
    ...
    cleaned_data = spatial_operator.spatial_join(data, police_beats)
...
if __name__ == "__main__":
    ...
    # Call main function:
    data_to_save, header = crashes_data_cleaning(input_filepath, police_beats_filepath, output_filepath)
