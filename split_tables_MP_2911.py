...
schema_features = {
    "DamageToUser": [
        "PERSON_ID", "VEHICLE_ID", "RD_NO", "DAMAGE", "NUM_UNITS"],
    ...
    "PersonDimension": [
        ...
        "BAC_RESULT", "EJECTION", "SAFETY_EQUIPMENT", "AIRBAG_DEPLOYED"],

    "VehicleDimension": [
        "VEHICLE_ID", "MAKE", "MODEL", "VEHICLE_YEAR", "VEHICLE_TYPE",
        "VEHICLE_DEFECT", "VEHICLE_USE",
...
def split_into_tables(merged_data, schema_features):
    ...
    for row in merged_data:
        for table_name, columns in schema_features.items():
            ...
            if table_name == "VehicleDimension" and table_row.get("VEHICLE_ID") in (None, '', "None"):
                continue
...
if __name__ == "__main__":
    ...
    people_columns, people = read_csv("People[updated].csv")
    ...
    # Build VehicleDimension separately to ensure consistency
